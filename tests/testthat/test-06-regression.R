...
test_that("bart on p.score matches old", {
  ...
  # snapshot refreshed for dbarts 8e1e674c (prior-tree-init draw shift); sane
  # estimate for this noise-dominated 5-tree/5-sample fit (true tau ~ 0.27)
  expect_equal(fitted(fit, "cate"), 0.464286360120866)
})
...
test_that("bart w/p.weighting matches old", {
  ...
  expect_equal(fitted(fit, "pate"), 0.452295264908141)
})
