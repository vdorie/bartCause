...
test_that("bart fit matches manual call", {
  set.seed(22)
  res <- cibart:::getBartTreatmentFit(z, x, testData, n.chains = 1L, n.threads = 1L, n.burn = 50, n.samples = 150, n.trees = 75L)
  set.seed(22)
...
test_that("xbart fit matches manual call", {
  set.seed(22)
  res <- cibart:::getBartXValTreatmentFit(z, x, testData, n.chains = 1L, n.threads = 1L, n.burn = 50, n.samples = 150, n.trees = 75L, n.reps = 10L)
  set.seed(22)
  k <- c(0.5, 1, 2, 4, 8)
