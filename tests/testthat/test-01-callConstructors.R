...
test_that("treatment call with data as list argument returns valid output", {
  res <- cibart:::getTreatmentDataCall(stats::glm, z, x, testData)
...
test_that("treatment call with data as data.frame argument returns valid output", {
  ...
  res <- cibart:::getTreatmentDataCall(stats::glm, z, X1 + X2 + X3, df)
...
test_that("treatment call with literal arguments retuns valid output", {
  res <- cibart:::getTreatmentLiteralCall(stats::glm, testData$z, testData$x)
  ...
  z <- testData$z
  res <- cibart:::getTreatmentLiteralCall(stats::glm, z, x)
...
test_that("response call with data as list argument returns valid output", {
  res <- cibart:::getResponseDataCall(stats::lm, y, z, x, testData)
  ...
  ## p.score in testData
  res <- cibart:::getResponseDataCall(stats::lm, y, z, x, testData, p.score = p.score)
  ...
  res <- cibart:::getResponseDataCall(stats::lm, y, z, x, testData, p.score = testData$p.score)
...
test_that("response call with data as data.frame argument returns valid output", {
  ...
  res <- cibart:::getResponseDataCall(stats::lm, y, z, X1 + X2 + X3, df)
  ...
  ## p.score in testData
  res <- cibart:::getResponseDataCall(stats::lm, y, z, X1 + X2 + X3, df, p.score = p.score)
  ...
  ## p.score supplied as literal
  res <- cibart:::getResponseDataCall(stats::lm, y, z, X1 + X2 + X3, df, p.score = df$p.score)
...
test_that("response call with data as data.frame argument returns valid output", {
  res <- cibart:::getResponseLiteralCall(stats::lm, testData$y, testData$z, testData$x)
  ...
  res <- cibart:::getResponseLiteralCall(stats::lm, testData$y, testData$z, testData$x, p.score = testData$p.score)
